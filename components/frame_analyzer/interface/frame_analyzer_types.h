...
/**
 * @brief Structure representing the frame control field in a WiFi frame.
 * 
 * The frame control field contains various control flags and fields that provide information about the frame.
 */
typedef struct {
 ...
 */
/**
 * @brief Structure representing an EAPOL key packet.
 * 
 * This structure is used to encapsulate the information of an EAPOL key packet.
 * It contains various fields such as descriptor type, key information, key length,
 * key replay counter, key nonce, key IV, key RSC, reserved bytes, key MIC,
 * key data length, and key data.
 */
